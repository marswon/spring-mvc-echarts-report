...
public class ReportSqlServiceImpl implements ReportSqlService{
	...
	@Override
	public Long saveReportSql(String baseSql, String sqlName) {
...
//	    String baseSql = "with () select count(*) over(order by) from dual";
	    ...
	    if (lastFromIndex < lastOrderIndex) {
...
//	    String str = "select 1 from dual order by 1 desc";
	...
	public DataGrid findReportSqlList(ReportSqlVO reportSqlVo,
		...
		String sql = "select sql_id \"sqlId\", base_sql \"baseSql\", base_count_sql \"baseCountSql\", rptname \"rptname\" from rp_report_sql where 1=1 "+ constructSqlWhere(reportSqlVo)
				+ " order by 1 desc" ;
