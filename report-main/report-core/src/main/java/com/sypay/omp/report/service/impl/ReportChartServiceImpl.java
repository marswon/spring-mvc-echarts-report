...
public class ReportChartServiceImpl implements ReportChartService {
	...
	public DataGrid findChartList(ChartVO chart, PageHelper pageHelper) {
		...
		String sql = "select id \"id\",chartoption \"chartOption\",datavsle \"dataVsLe\",toolflag \"toolFlag\",order_num \"chartOrder\",name \"chartName\",charttype \"chartType\",datavsx \"dataVsX\" from rptchart where 1=1 " + constructSqlWhere(chart)
				+ " order by 5 desc";
