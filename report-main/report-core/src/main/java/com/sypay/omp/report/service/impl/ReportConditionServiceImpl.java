...
public class ReportConditionServiceImpl implements ReportConditionService {
	...
	public DataGrid findConditionList(ConditionVO condition,
		...
		String sql = "select id \"Id\", conmuti \"conMuti\", conname \"conName\", conoption \"conOption\", contype \"conType\", conwhere \"conWhere\", toolflag \"toolFlag\", order_num \"orderNum\", default_value \"conDefaultValue\", row_num \"rowNum\" from rptcon where 1=1 "+ constructSqlWhere(condition)
				+ " order by 1 desc" ;
