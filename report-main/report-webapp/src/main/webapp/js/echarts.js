...
function(e) {
    ...
    s = typeof window.addEventListener == "function" ?
    function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        e.cancelBubble = !0
...
function(e) {
    ...
    function m(e, t, n) {
        ...
        if (e.isCover(t, n)) {
            ...
            return this._lastHover != e && (this._processOutShape(r), this._processDragLeave(r), this._lastHover = e, this._processDragEnter(r)),
            this._processOverShape(r),
            this._processDragOver(r),
            this._hasfound = 1,
            !0
        }
        return ! 1
    ...
    l = {
        ...
        click: function(e) {
            ...
            var t = this._lastHover; (t && t.clickable || !t) && this._dispatchAgency(t, u.CLICK, e),
            this._mousemoveHandler(e)
        },
        dblclick: function(e) {
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && this._dispatchAgency(t, u.DBLCLICK, e),
            this._mousemoveHandler(e)
        },
        mousewheel: function(e) {
            ...
            for (var s in r) if (s !== "hover") {
                ...
                if (o.zoomable) {
                    ...
                    var f = o.__zoom;
                    f *= n,
                    f = Math.max(Math.min(o.maxZoom, f), o.minZoom),
                    n = f / o.__zoom,
                    o.__zoom = f,
                    a[0] -= (this._mouseX - a[0]) * (n - 1),
                    a[1] -= (this._mouseY - a[1]) * (n - 1),
                    o.scale[0] *= n,
                    o.scale[1] *= n,
                    o.dirty = !0,
                    i = !0
        ...
        mousemove: function(e) {
            ...
            var i = "default";
            if (this._draggingTarget) this.storage.drift(this._draggingTarget.id, t, n),
            this.storage.addHover(this._draggingTarget);
            else if (this._isMouseDown) {
                var s = this.painter.getLayers(),
                o = !1;
            ...
            this._draggingTarget || this._hasfound && this._lastHover.draggable ? i = "move": this._hasfound && this._lastHover.clickable && (i = "pointer"),
        ...
        touchend: function(e) {
            ...
            var t = new Date;
            t - this._lastTouchMoment < u.touchClickDelay && (this._mobildFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < u.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && r.stop(e)), this._lastClickMoment = t),
            this.painter.clearHover()
        }
    },
    d = function(e, t, r) {
        ...
        this._findHover = h(m, this),
        this._domHover = r.getDomHover(),
        p(this),
        window.addEventListener ? (window.addEventListener("resize", this._resizeHandler), n.os.tablet || n.os.phone ? (e.addEventListener("touchstart", this._touchstartHandler), e.addEventListener("touchmove", this._touchmoveHandler), e.addEventListener("touchend", this._touchendHandler)) : (e.addEventListener("click", this._clickHandler), e.addEventListener("dblclick", this._dblclickHandler), e.addEventListener("mousewheel", this._mousewheelHandler), e.addEventListener("mousemove", this._mousemoveHandler), e.addEventListener("mousedown", this._mousedownHandler), e.addEventListener("mouseup", this._mouseupHandler)), e.addEventListener("DOMMouseScroll", this._mousewheelHandler), e.addEventListener("mouseout", this._mouseoutHandler)) : (window.attachEvent("onresize", this._resizeHandler), e.attachEvent("onclick", this._clickHandler), e.attachEvent("ondblclick ", this._dblclickHandler), e.attachEvent("onmousewheel", this._mousewheelHandler), e.attachEvent("onmousemove", this._mousemoveHandler), e.attachEvent("onmouseout", this._mouseoutHandler), e.attachEvent("onmousedown", this._mousedownHandler), e.attachEvent("onmouseup", this._mouseupHandler))
    };
    ...
    d.prototype._processDragEnd = function(e) {
        this._draggingTarget && (this._dispatchAgency(this._draggingTarget, u.DRAGEND, e), this._lastHover = null),
        this._isDragging = 0,
    ...
    i.merge(d.prototype, a.prototype, !0),
    d
}),
...
function(e) {
    ...
    function h(e, t, n, s, o, u) {
        ...
        if (a(p) && a(d)) if (a(l)) u[0] = 0;
            ...
            if (a(y)) {
                ...
                S = p * l + 1.5 * f * ( - d + E),
                x = p * l + 1.5 * f * ( - d - E);
                S < 0 ? S = -Math.pow( - S, i) : S = Math.pow(S, i),
                x < 0 ? x = -Math.pow( - x, i) : x = Math.pow(x, i);
                var g = ( - l - (S + x)) / (3 * f);
                g >= 0 && g <= 1 && (u[m++] = g)
            } else {
    ...
    function v(e, r, i, a, f, c, h, p, d, v, m) {
        ...
        return m && (m[0] = l(e, i, f, h, g), m[1] = l(r, a, c, p, g)),
        Math.sqrt(b)
    }
    function m(e, t, n, r) {
        var i = 1 - r;
    ...
    function w(e, r, i, a, f, l, c, h, p) {
        ...
        return p && (p[0] = m(e, i, f, d), p[1] = m(r, a, l, d)),
        Math.sqrt(g)
    }
    var t = e("./vector"),
    n = 1e-4,
...
function(e) {
    ...
    function A(e, t, r, i, s, o, u, a, f, l) {
        ...
        for (var m = 0; m < c; m++) {
            ...
            if (y < f) continue;
            p < 0 && (p = n.cubicExtrema(t, i, o, a, k), k[1] < k[0] && p > 1 && L(), d = n.cubicAt(t, i, o, a, k[0]), p > 1 && (v = n.cubicAt(t, i, o, a, k[1]))),
            p == 2 ? g < k[0] ? h += d < t ? 1 : -1 : g < k[1] ? h += v < d ? 1 : -1 : h += a < v ? 1 : -1 : g < k[0] ? h += d < t ? 1 : -1 : h += a < d ? 1 : -1
        }
        return h
    }
    ...
    function M(e, t, n, r, i, s, o, u) {
        ...
        for (var h = 0; h < 2; h++) {
            var p = C[h];
            if (p + e > o) {
                var d = Math.atan2(u, p),
                v = s ? 1 : -1;
                d < 0 && (d = f + d);
                if (d >= r && d <= i || d + f >= r && d + f <= i) d > Math.PI / 2 && d < Math.PI * 1.5 && (v = -v),
                c += v
            }
        }
        return c
    ...
    function D(e, n) {
        ...
        var u = 0;
        for (var f = 0,
        l = e.length; f < l; f++) u = Math.max(r.measureText(e[f]).width, u);
        return r.restore(),
        i[s] = u,
        ++o > a && (o = 0, i = {}),
        u
    ...
    return u.prototype = {
        ...
        updateTransform: function() {
            ...
            if (this.needLocalTransform) {
                if (o(this.scale[0]) || o(this.scale[1])) {
                    ...
                    n && (r[0] = -r[0], r[1] = -r[1], t.translate(e, e, r))
                }
                ...
                } else this.rotation !== 0 && t.rotate(e, e, this.rotation); (o(this.position[0]) || o(this.position[1])) && t.translate(e, e, this.position)
            }
            this.transform = e,
        ...
        lookAt: function() {
            ...
            return function(r) {
                ...
                n.normalize(e, e),
                i[2] = e[0] * this.scale[1],
                i[3] = e[1] * this.scale[1],
                i[0] = e[1] * this.scale[0],
                i[1] = -e[0] * this.scale[0],
                i[4] = this.position[0],
                i[5] = this.position[1],
...
define("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/util", "../tool/log", "../mixin/Transformable", "../mixin/Eventful", "../tool/area", "../tool/area", "../tool/color", "../tool/area"],
function(e) {
    ...
    f.prototype.invisible = !1,
    f.prototype.ignore = !1,
    f.prototype.zlevel = 0,
    f.prototype.draggable = !1,
    f.prototype.clickable = !1,
    f.prototype.hoverable = !0,
    f.prototype.z = 0,
    f.prototype.brush = function(e, t) {
        var n = this.style;
    ...
    f.prototype.drawText = function(e, t, n) {
        ...
        e.fillStyle = r;
        var i = 10,
        s, o, a, f, l = t.textPosition || this.textPosition || "top";
        switch (l) {
        case "inside":
        case "top":
        case "bottom":
    ...
    r.merge(f.prototype, s.prototype, !0),
    r.merge(f.prototype, o.prototype, !0),
    f
}),
...
function(e) {
    ...
    return n.prototype = {
        ...
        _buildRadiusPath: function(e, t) {
            ...
            var c;
            u + a > i && (c = u + a, u *= i / c, a *= i / c),
            f + l > i && (c = f + l, f *= i / c, l *= i / c),
            a + f > s && (c = a + f, a *= s / c, f *= s / c),
            u + l > s && (c = u + l, u *= s / c, l *= s / c),
            e.moveTo(n + u, r),
            e.lineTo(n + i - a, r),
...
function(e) {
    ...
    return i.prototype = {
        ...
        brush: function(e, r, i) {
            ...
            if (o) {
                ...
                s.width || (s.width = f),
                s.height || (s.height = l),
                this.style.width || (this.style.width = f),
                this.style.height || (this.style.height = l),
                this.drawText(e, s, this.style),
                e.restore()
            }
        },
        getRect: function(e) {
    ...
    e("../tool/util").inherits(i, r),
    i
}),
define("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./tool/matrix", "./loadingEffect/Base", "./mixin/Transformable", "./shape/Image"],
function(e) {
    function f() {
        return ! 1
    }
    ...
    function h(e, t, n) {
        ...
        r.style.width = i + "px",
        r.style.height = s + "px",
        r.setAttribute("width", i * u),
        r.setAttribute("height", s * u),
    ...
    u = Math.max(u, 1);
    var a = window.G_vmlCanvasManager,
    c = function(e, t) {
        this.root = e,
        this.storage = t,
        e.innerHTML = "",
        ...
        this._bgDom = h("bg", "div", this),
        n.appendChild(this._bgDom),
        this._bgDom.onselectstart = f,
    ...
    c.prototype.getLayer = function(e, t) {
        ...
        if (!r) {
            ...
            i.nextSibling ? i.parentNode.insertBefore(r.dom, i.nextSibling) : i.parentNode.appendChild(r.dom),
            r.initContext(),
            this._layers[e] = r,
            this._layerConfig[e] && n.merge(r, this._layerConfig[e], !0),
            r.updateTransform()
        }
        return r
    },
    ...
    c.prototype.toDataURL = function(e, n, i) {
        ...
        u != 1 && o.scale(u, u),
        o.fillStyle = n || "#fff",
        o.rect(0, 0, this._width * u, this._height * u),
        o.fill();
        var f = this;
    ...
    var p = function(e, t) {
        this.dom = h(e, "canvas", t),
        this.dom.onselectstart = f,
        this.dom.style["-webkit-user-select"] = "none",
        this.dom.style["user-select"] = "none",
        a && a.initElement(this.dom),
        this.domBack = null,
        this.ctxBack = null,
        this.painter = t,
        this.unusedCount = 0,
    ...
    return p.prototype.initContext = function() {
        ...
        u != 1 && this.ctx.scale(u, u)
    },
    p.prototype.createBackBuffer = function() {
        if (a) return;
        this.domBack = h("back-" + this.id, "canvas", this.painter),
        this.ctxBack = this.domBack.getContext("2d"),
        u != 1 && this.ctxBack.scale(u, u)
    },
    p.prototype.resize = function(e, t) {
        this.dom.style.width = e + "px",
        this.dom.style.height = t + "px",
        this.dom.setAttribute("width", e * u),
        this.dom.setAttribute("height", t * u),
        u != 1 && this.ctx.scale(u, u),
        this.domBack && (this.domBack.setAttribute("width", e * u), this.domBack.setAttribute("height", t * u), u != 1 && this.ctxBack.scale(u, u))
    },
    p.prototype.clear = function() {
        ...
        i = this.clearColor && !a,
        s = this.motionBlur && !a,
        o = this.lastFrameAlpha;
        s && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(e, 0, 0, n / u, r / u)),
        i ? (t.save(), t.fillStyle = this.config.clearColor, t.fillRect(0, 0, n / u, r / u), t.restore()) : t.clearRect(0, 0, n / u, r / u);
        if (s) {
            var f = this.domBack;
            t.save(),
            t.globalAlpha = o,
            t.drawImage(f, 0, 0, n / u, r / u),
            t.restore()
        }
    },
    n.merge(p.prototype, o.prototype),
    c
}),
...
function(e) {
    ...
    c.prototype.animate = function(e, r, i) {
        ...
        if (e) {
            ...
            return typeof e.__aniCount == "undefined" && (e.__aniCount = 0),
            e.__aniCount === 0 && l.push(e),
            e.__aniCount++,
            this.animation.animate(s, {
                loop: i
            }).done(function() {
                e.__aniCount--;
                if (e.__aniCount === 0) {
...
function(e) {
    ...
    return function(e, n, r, i) {
        ...
        if (c) {
            ...
            p = [ - Infinity, -Infinity];
            for (var d = 0,
            v = e.length; d < v; d++) t.min(h, h, e[d]),
            t.max(p, p, e[d]);
            t.min(h, h, i[0]),
            t.max(p, p, i[1])
        }
        ...
        v = e.length; d < v; d++) {
            ...
            var w = t.add([], m, u),
            E = t.add([], m, a);
            c && (t.max(w, w, h), t.min(w, w, p), t.max(E, E, h), t.min(E, E, p)),
            s.push(w),
            s.push(E)
        }
        return r && s.push(s.shift()),
        s
    }
}),
...
function(e) {
    ...
    return s.prototype = {
        ...
        brush: function(e, t) {
            ...
            e.closePath(),
            e.fill();
            n.lineWidth > 0 && (n.brushType == "stroke" || n.brushType == "both") && (r || (e.beginPath(), this.buildPath(e, n)), e.stroke()),
            this.drawText(e, n, this.style),
            e.restore();
            return
        },
...
function(e) {
    ...
    return h.prototype = {
        ...
        addLabel: function(e, t, n, r, i) {
            ...
            a = o.textStyle || {},
            f = u.textStyle || {};
            return o.show && (e.style.text = this._getLabelText(t, n, r, "normal"), e.style.textPosition = o.position == null ? i === "horizontal" ? "right": "top": o.position, e.style.textColor = a.color, e.style.textFont = this.getFont(a)),
            u.show && (e.highlightStyle.text = this._getLabelText(t, n, r, "emphasis"), e.highlightStyle.textPosition = o.show ? e.style.textPosition: u.position == null ? i === "horizontal" ? "right": "top": u.position, e.highlightStyle.textColor = f.color, e.highlightStyle.textFont = this.getFont(f)),
            e
        },
        ...
        _buildMarkPoint: function(e) {
            ...
            u.data[a].x = i.x != null ? i.x: o[0],
            u.data[a].y = i.y != null ? i.y: o[1],
        ...
        _buildMarkLine: function(e) {
            ...
            {}]),
            u.data[a][0].x = i[0].x != null ? i[0].x: o[0][0],
            u.data[a][0].y = i[0].y != null ? i[0].y: o[0][1],
            u.data[a][1].x = i[1].x != null ? i[1].x: o[1][0],
            u.data[a][1].y = i[1].y != null ? i[1].y: o[1][1];
        ...
        _markPoint: function(e, t) {
            ...
            E = u.length; w < E; w++) {
                ...
                p = u[w] != null && u[w].value != null ? u[w].value: "",
                ...
                u[w].name = u[w].name != null ? u[w].name: "",
                u[w].value = p,
        ...
        _markLine: function(e, t) {
            ...
            S = u.length; E < S; E++) {
                ...
                u[E][0].name = u[E][0].name != null ? u[E][0].name: "",
                u[E][1].name = u[E][1].name != null ? u[E][1].name: "",
                u[E][0].value = u[E][0].value != null ? u[E][0].value: "",
        ...
        getSymbolShape: function(e, r, i, s, u, a, f, l, c, h, p) {
            var d = [i, e],
            v = i != null ? i.value != null ? i.value: i: "-";
            ...
            g != null && (S.rotation = [g * Math.PI / 180, a, f]),
            ...
            l.match("empty") && (S.style.textColor == null && (S.style.textColor = S.style.strokeColor), S.highlightStyle.textColor == null && (S.highlightStyle.textColor = S.highlightStyle.strokeColor)),
            o.pack(S, e, r, i, s, u),
            S._x = a,
            S._y = f,
            S._dataIndex = s,
        ...
        getLargeMarkPoingShape: function(e, t) {
            ...
            if (u) {
                l = s[0] != null ? s[0].value != null ? s[0].value: s[0] : "-",
        ...
        addMark: function(e, t, n) {
            ...
            if (this.selectedMap[r.name]) {
                ...
                if (this.option.animation && !this.option.renderAsImage) this.animationMark(i, s, this.shapeList.slice(u));
                else {
                    for (var a = u,
...
function(e) {
    ...
    return d.prototype = {
        ...
        _style: function(e) {
            ...
            e.borderWidth != null && t.push("border-width:" + e.borderWidth + "px"),
            e.borderColor != null && t.push("border-color:" + e.borderColor),
            e.borderRadius != null && (t.push("border-radius:" + e.borderRadius + "px"), t.push("-moz-border-radius:" + e.borderRadius + "px"), t.push("-webkit-border-radius:" + e.borderRadius + "px"), t.push("-o-border-radius:" + e.borderRadius + "px"));
            var r = e.textStyle;
            ...
            var i = e.padding;
            return i != null && (i = this.reformCssArray(i), t.push("padding:" + i[0] + "px " + i[1] + "px " + i[2] + "px " + i[3] + "px")),
            t = t.join(";") + ";",
            t
        },
        __hide: function() {
        ...
        __tryShow: function() {
            ...
            if (!this._curTarget) this._findPolarTrigger() || this._findAxisTrigger();
                ...
                n == null || r == null || !e ? (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._hidingTicket = setTimeout(this._hide, this._hideDelay)) : (t = this.deepQuery([r, n, this.option], "tooltip.trigger"), t === "axis" ? this._showAxisTrigger(n.xAxisIndex, n.yAxisIndex, u.get(this._curTarget, "dataIndex")) : this._showItemTrigger())
            }
        },
        ...
        _getNearestDataIndex: function(e, t) {
            ...
            if (e === "x") {
                ...
                return n <= 0 ? n = 0 : r - s <= o - r ? n -= 1 : t.getNameByIndex(n) == null && (n -= 1),
                n
            }
            ...
            return n <= 0 ? n = 0 : i - l >= c - i ? n -= 1 : t.getNameByIndex(n) == null && (n -= 1),
            n
        },
        _showAxisTrigger: function(e, t, n) { ! this._event.connectTrigger && this.messageCenter.dispatch(o.EVENT.TOOLTIP_IN_GRID, this._event, null, this.myChart);
            ...
            if (i.length > 0) {
                ...
                if (typeof c == "function") {
                    ...
                    g = g != null ? g.value != null ? g.value: g: "-",
        ...
        _showItemTrigger: function() {
            ...
            this._tDom.innerHTML = a;
                ...
                this._curTicket = NaN;
                if (e.type === o.CHART_TYPE_SCATTER) this._tDom.innerHTML = "" + (e.name != null ? this._encodeHTML(e.name) + "<br/>": "") + (n === "" ? "": this._encodeHTML(n) + " : ") + r + (i == null ? "": " (" + i + ")");
                ...
                } else if (e.type === o.CHART_TYPE_CHORD) if (s == null) this._tDom.innerHTML = this._encodeHTML(n) + " (" + this.numAddCommas(r) + ")";
                else {
        ...
        showTip: function(e) {
            ...
            if (e.seriesIndex != null) t = e.seriesIndex;
            else {
                var r = e.seriesName;
                for (var i = 0,
...
function(e) {
    ...
    return f.prototype = {
        ...
        _getReformedLabel: function(e) {
            ...
            n = t.data[e].name != null ? t.data[e].name: t.data[e],
        ...
        play: function(e, t) {
            ...
            this.timelineOption.autoPlay = t != null ? t: !0,
            this.timelineOption.autoPlay || clearTimeout(this.playTicket),
            this.currentIndex = e != null ? e: this.currentIndex + 1,
            this.currentIndex >= this.timelineOption.data.length && (this.currentIndex = 0),
            this._onFrame(),
            this.currentIndex
        },
...
function(e) {
    ...
    o.prototype._start = function(e, t) {
        ...
        c.x = h.x + c.r,
        c.y = u.highlightStyle.y = h.y + h.height / 2,
        u.highlightStyle.x = c.x + c.r + a;
        ...
        return setInterval(function() {
            e(p),
            x[0] -= .3;
            for (var n = 0; n < d; n++) w[n].rotation = x,
            e(w[n]);
            e(u),
            t()
        },
...
function(e) {
    ...
    s = e("../shape/Droplet"),
    o = e("../shape/Circle");
    return n.inherits(u, t),
    u.prototype._start = function(e, t) {
        ...
        h.x = p.x + h.r,
        h.y = a.highlightStyle.y = p.y + p.height / 2,
        a.highlightStyle.x = h.x + h.r + f;
        ...
        y = [0, h.x, h.y];
        return v.highlightStyle.x = m.highlightStyle.x = g.highlightStyle.x = y[1],
        v.highlightStyle.y = m.highlightStyle.y = g.highlightStyle.y = y[2],
        setInterval(function() {
            e(d),
            e(g),
            y[0] -= .3,
    ...
    return l.prototype = {
        _init: function() {
            ...
            this._messageCenter.dispatch = function(e, t, r, i) {
                ...
                e != "HOVER" && e != "MOUSEOUT" ? setTimeout(function() {
            ...
            (r.getWidth() === 0 || r.getHeight() === 0) && console.error("Dom’s width & height should be ready before init.")
        },
                ...
                if (h) {
                    ...
                    if (o != null) {
                        ...
                        if (h.type === t.CHART_TYPE_PIE && (g = f.legend) && (y = g.data)) {
                            ...
                            if (f.xAxis[x].type == null || f.xAxis[x].type === "category") E = f.xAxis[x].data,
                            S = a.xAxis[x].data,
                            E[p](o),
                            S[p](o),
                            s || (E[d](), S[d]());
...
function(e) {
    ...
    return p.prototype = {
        ...
        _buildAxisLabel: function(e) {
            ...
            g,
            y;
            for (var b = 0; b <= n; b++) y = c.accAdd(r, c.accMul(c.accDiv(s, n), b)),
            v = h - p / n * b,
            ...
            if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                ...
                a = this.series.length; u < a; u++) {
                    ...
                    if (!this.series[u].stack) {
                        ...
                        for (var l = 0,
                        c = e.length; l < c; l++) n = e[l].value != null ? e[l].value: e[l],
                        ...
                        c = e.length; l < c; l++) {
                            ...
                            if (n === "-") continue;
                            n -= 0,
                            n >= 0 ? t[h][l] != null ? t[h][l] += n: t[h][l] = n: t[p][l] != null ? t[p][l] += n: t[p][l] = n,
    ...
    return u.prototype = {
        ...
        axisBase: {
            ...
            refixAxisShape: function(e, t) {
                ...
                var n;
                if (this.isHorizontal() && t != null) for (var r = 0,
                ...
                if (!this.isHorizontal() && e != null) for (var r = 0,
...
function(e) {
    ...
    return u.prototype = {
        ...
        _calculScatterMap: function(t) {
            ...
            i instanceof Array ? (i[0].type = "value", i[0].scale = !0, i[1] && (i[1].type = "value", i[1].boundary = [0, 0])) : (i.type = "value", i.scale = !0, i.boundary = [0, 0]),
        ...
        _buildSeries: function(e) {
            ...
            h = e.length; c < h; c++) {
                ...
                d = r.data.length; p < d; p++) {
                    i = r.data[p],
                    s = i != null ? i.value != null ? i.value: i: "-";
        ...
        _buildHorizontal: function(e, t, n) {
            ...
            m = n.length; v < m; v++) {
                ...
                y = t; g < y; g++) {
                    ...
                    h = s.data[g],
                    p = h != null ? h.value != null ? h.value: h: "-";
...
function(e) {
    ...
    return r.prototype.fastBoundingRect = function() {
        ...
        for (var r = 0; r < this.pathCommands.length; r++) {
            ...
            case "L":
                ...
                break;
            case "C":
                for (var o = 0; o < 6; o += 2) e[0] = Math.min(e[0], e[0], s[o]),
                e[1] = Math.min(e[1], e[1], s[o + 1]),
                n[0] = Math.max(n[0], n[0], s[o]),
                n[1] = Math.max(n[1], n[1], s[o + 1]);
                break;
            case "Q":
                for (var o = 0; o < 4; o += 2) e[0] = Math.min(e[0], e[0], s[o]),
                e[1] = Math.min(e[1], e[1], s[o + 1]),
                n[0] = Math.max(n[0], n[0], s[o]),
                n[1] = Math.max(n[1], n[1], s[o + 1]);
                break;
            case "A":
                ...
                f = s[2],
                l = s[3];
                e[0] = Math.min(e[0], e[0], u - f),
                e[1] = Math.min(e[1], e[1], a - l),
                n[0] = Math.max(n[0], n[0], u + f),
                n[1] = Math.max(n[1], n[1], a + l)
            }
        }
        return {
            x: e[0],
    ...
    r.prototype.moveTo = function(e, t) {
        return this.pathCommands.push(new n("M", [e, t])),
        this._ctx && this._ctx.moveTo(e, t),
        this
    },
    r.prototype.lineTo = function(e, t) {
        return this.pathCommands.push(new n("L", [e, t])),
        this._ctx && this._ctx.lineTo(e, t),
        this
    },
    r.prototype.bezierCurveTo = function(e, t, r, i, s, o) {
        return this.pathCommands.push(new n("C", [e, t, r, i, s, o])),
        this._ctx && this._ctx.bezierCurveTo(e, t, r, i, s, o),
        this
    },
    r.prototype.quadraticCurveTo = function(e, t, r, i) {
        return this.pathCommands.push(new n("A", [e, t, r, i])),
        this._ctx && this._ctx.quadraticCurveTo(e, t, r, i),
        this
    },
    r.prototype.arc = function(e, t, r, i, s, o) {
        return this.pathCommands.push(new n("A", [e, t, r, r, i, s - i, 0, o ? 0 : 1])),
        this._ctx && this._ctx.arc(e, t, r, i, s, o),
        this
    },
    r.prototype.arcTo = function(e, t, n, r, i) {
        return this._ctx && this._ctx.arcTo(e, t, n, r, i),
        this
    },
    r.prototype.rect = function(e, t, n, r) {
        return this._ctx && this._ctx.rect(e, t, n, r),
        this
    },
    r.prototype.closePath = function() {
        return this.pathCommands.push(new n("z")),
...
define("echarts/util/shape/Ribbon", ["require", "zrender/shape/Base", "zrender/shape/util/PathProxy", "zrender/tool/util", "zrender/tool/area"],
function(e) {
    function s(e) {
        t.call(this, e),
        this._pathProxy = new n
    }
    var t = e("zrender/shape/Base"),
    ...
    return s.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            s = t.y,
            o = t.r,
            u = t.source0 / 180 * Math.PI,
            a = t.source1 / 180 * Math.PI,
            f = t.target0 / 180 * Math.PI,
            l = t.target1 / 180 * Math.PI,
            c = i + Math.cos(r - u) * o,
            h = s - Math.sin(r - u) * o,
            p = i + Math.cos(r - a) * o,
            d = s - Math.sin(r - a) * o,
            ...
            n.moveTo(c, h),
            n.arc(i, s, t.r, u, a, !1),
            n.bezierCurveTo((i - p) * .7 + p, (s - d) * .7 + d, (i - v) * .7 + v, (s - m) * .7 + m, v, m);
            if (t.source0 === t.target0 && t.source1 === t.target1) return;
            n.arc(i, s, t.r, f, l, !1),
            n.bezierCurveTo((i - g) * .7 + g, (s - y) * .7 + y, (i - c) * .7 + c, (s - h) * .7 + h, c, h)
        },
        getRect: function(e) {
...
define("echarts/chart/chord", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Sector", "../util/shape/Ribbon", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"],
function(e) {
    function p(e, r, i, s, o) {
        t.call(this, e, r, i, s, o),
        n.call(this),
...
function(e) {
    ...
    n.prototype.addEdge = function(e, t, r) {
        typeof e == "string" && (e = this._nodesMap[e]),
        typeof t == "string" && (t = this._nodesMap[t]);
        if (!e || !t) return;
        var i = e.name + "-" + t.name;
        if (this._edgesMap[i]) return this._edgesMap[i];
        var s = new n.Edge(e, t, r);
        return this._directed && (e.outEdges.push(s), t.inEdges.push(s)),
        e.edges.push(s),
        t.edges.push(s),
        this.edges.push(s),
        this._edgesMap[i] = s,
    ...
    n.prototype.removeEdge = function(e) {
        ...
        r = e.node2,
        i = n.name + "-" + r.name;
        this._directed && (n.outEdges.splice(t.indexOf(n.outEdges, e), 1), r.inEdges.splice(t.indexOf(r.inEdges, e), 1)),
        n.edges.splice(t.indexOf(n.edges, e), 1),
        r.edges.splice(t.indexOf(r.edges, e), 1),
        delete this._edgesMap[i],
    ...
    n.fromMatrix = function(e, t, r) {
        ...
        for (var o = 0; o < i; o++) {
            ...
            u.data.value = 0,
            r && (u.data.outValue = u.data.inValue = 0)
        }
        for (var o = 0; o < i; o++) for (var a = 0; a < i; a++) {
            var f = t[o][a];
            r && (s.nodes[o].outValue += f, s.nodes[a].inValue += f),
            s.nodes[o].value += f,
            s.nodes[a].value += f
        }
        for (var o = 0; o < i; o++) for (var a = o; a < i; a++) {
            ...
            c = s.nodes[a],
            h = s.addEdge(l, c, {});
            r && (h.data.sourceWeight = f, h.data.targetWeight = t[a][o]),
            h.data.weight = f;
            if (o !== a) {
                if (r) {
                    var p = s.addEdge(c, l, {});
                    p.sourceWeight = t[a][o],
                    p.targetWeight = f
                }
                h.data.weight += t[a][o]
            }
...
define("echarts/layout/forceLayoutWorker", ["require", "zrender/tool/vector"],
function e(t) {
    function s() {
        this.subRegions = [],
        this.nSubRegions = 0,
...
define("echarts/layout/Force", ["require", "./forceLayoutWorker", "zrender/tool/vector"],
function(e) {
    function o() {
    ...
    var t = e("./forceLayoutWorker"),
    n = e("zrender/tool/vector"),
    ...
    i = typeof Float32Array == "undefined" ? Array: Float32Array,
    s,
    a = function(e) {
        typeof s == "undefined" && u(),
        e = e || {},
        ...
        this.gravity = typeof e.gravity != "undefined" ? e.gravity: 1,
    ...
    a.prototype.init = function(e, n) {
        if (s && n) try {
            this._layoutWorker || (this._layoutWorker = new Worker(s), this._layoutWorker.onmessage = this._$onupdate),
            this._layout = null
        } catch(r) {
            this._layoutWorker = null,
            this._layout || (this._layout = new t)
        } else this._layout || (this._layout = new t),
        ...
        for (var c = 0; c < u; c++) {
            var h = e.nodes[c];
            a[c * 2] = h.layout.position[0],
            a[c * 2 + 1] = h.layout.position[1],
            f[c] = h.layout.mass,
            l[c] = h.layout.radius,
            h.layout.__index = c
        }
        ...
        for (var c = 0; c < u; c++) {
            var v = e.edges[c];
            p[c * 2] = v.node1.layout.__index,
            p[c * 2 + 1] = v.node2.layout.__index,
            d[c] = v.layout.weight || 1
        }
        this._token = o(),
        this._layoutWorker ? this._layoutWorker.postMessage({
            ...
            edgesWeight: d,
            token: this._token
        }) : (this._layout.setToken(this._token), this._layout.initNodes(a, f, l), this._layout.initEdges(p, d)),
        this.updateConfig()
    },
    a.prototype.step = function(e) {
        ...
        if (this._layoutWorker) {
            ...
            for (var o = 0; o < t.length; o++) {
                var u = t[o];
                s[o * 2 + 1] = u.layout.position[0],
                s[o * 2 + 2] = u.layout.position[1]
            }
            this._layoutWorker.postMessage(s.buffer, [s.buffer]),
            ...
            for (var o = 0; o < e; o++) this._layout.temperature = this.temperature,
            this._layout.update(),
        ...
        if (this._layoutWorker) {
            ...
            if (r === this._token) {
                for (var i = 0; i < this.graph.nodes.length; i++) {
                    ...
                    s.layout.position[0] = t[i * 2 + 1],
                    s.layout.position[1] = t[i * 2 + 2]
                }
...
define("echarts/chart/force", ["require", "../component/base", "./base", "../data/Graph", "../layout/Force", "zrender/shape/Line", "zrender/shape/Image", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../chart"],
function(e) {
    function p(e, s, o, u, a) {
        var f = this;
        t.call(this, e, s, o, u, a),
        n.call(this),
    ...
    function d(e) {
        ...
        t.fixed = !0,
        this.isDragstart = !1,
        this.zr.on(c.EVENT.MOUSEMOVE, this.onmousemove)
    }
    function v() {
    ...
    function m(e, t) {
        ...
        t.needRefresh = !1,
        this.isDragend = !1,
        this.zr.un(c.EVENT.MOUSEMOVE, this.onmousemove)
    }
    function g(e, t, n) {
        var r = h.create();
        return r[0] = (Math.random() - .5) * n + e,
        r[1] = (Math.random() - .5) * n + t,
        r
    }
    var t = e("../component/base"),
    n = e("./base"),
    ...
    return p.prototype = {
        ...
        _init: function() {
            ...
            i = t.length; r < i; r++) {
                ...
                if (s.type === a.CHART_TYPE_FORCE) {
                    ...
                    var o = s.categories;
                    for (var u = 0,
                    f = o.length; u < f; u++) o[u].name && (e ? this.selectedMap[u] = e.isSelected(o[u].name) : this.selectedMap[u] = !0);
                    this._forceSerie = s,
                    this._initSerie(s);
                    break
                }
        ...
        _initSerie: function(e) {
            ...
            for (var n = 0,
            r = e.links.length; n < r; n++) {
                var o = e.links[n],
                u = o.source,
                a = o.target;
                typeof u == "number" && (u = e.nodes[u], u && (u = u.name)),
                typeof a == "number" && (a = e.nodes[a], a && (a = a.name));
                var f = t.addEdge(u, a, o);
                f && (f.rawIndex = n)
            }
            this._buildLinkShapes(e),
            this._buildNodeShapes(e),
            this._initLayout(e),
            this._step()
        },
        _initLayout: function(e) {
            var t = this._graph,
            n = t.nodes.length,
            r = this.query(e, "minRadius"),
            i = this.query(e, "maxRadius");
            ...
            for (var u = 0; u < n; u++) {
                ...
                o = Math.max(a.data.value, o),
                s = Math.min(a.data.value, s)
            }
            var f = o - s;
            for (var u = 0; u < n; u++) {
                var a = t.nodes[u];
            ...
            for (var u = 0; u < n; u++) {
                var a = t.nodes[u];
                if (typeof this.__nodePositionMap[a.name] != "undefined") a.layout.position = h.create(),
                h.copy(a.layout.position, this.__nodePositionMap[a.name]);
                else if (typeof a.data.initial != "undefined") a.layout.position = h.create(),
                h.copy(a.layout.position, a.data.initial);
                else {
                ...
                d = a.layout.radius;
                p.width = p.width || d * 2,
                p.height = p.height || d * 2,
                p.x = -p.width / 2,
                p.y = -p.height / 2,
                h.copy(a.shape.position, a.layout.position)
            }
            n = t.edges.length,
            o = -Infinity;
            for (var u = 0; u < n; u++) {
                ...
                v.layout.weight > o && (o = v.layout.weight)
            }
            for (var u = 0; u < n; u++) {
                var v = t.edges[u];
                v.layout.weight /= o
        ...
        _buildNodeShapes: function(e) {
            ...
            for (var s = 0; s < r; s++) {
                ...
                v = [];
                p.push(c),
                c.itemStyle && (d.push(c.itemStyle.normal), v.push(c.itemStyle.emphasis));
                if (typeof c.category != "undefined") {
                    var m = n[c.category];
                    m && (m.itemStyle = m.itemStyle || {},
                    m.itemStyle.normal = m.itemStyle.normal || {},
                    m.itemStyle.normal.color = m.itemStyle.normal.color || i.getColor(m.name), p.push(m), d.unshift(m.itemStyle.normal), v.unshift(m.itemStyle.emphasis))
                }
                p.push(e),
                d.unshift(e.itemStyle.normal.nodeStyle),
                v.unshift(e.itemStyle.emphasis.nodeStyle),
                h.style.iconType = this.deepQuery(p, "symbol"),
                h.style.width = h.style.height = (this.deepQuery(p, "symbolSize") || 0) * 2,
                h.style.iconType.match("image") && (h.style.image = h.style.iconType.replace(new RegExp("^image:\\/\\/"), ""), h = new o({
                    style: h.style,
                ...
                if (this.deepQuery(p, "itemStyle.normal.label.show")) {
                    h.style.text = c.name,
                    h.style.textPosition = "inside";
                    var y = this.deepQuery(p, "itemStyle.normal.label.textStyle") || {};
                    h.style.textColor = y.color || "#fff",
                    h.style.textAlign = y.align || "center",
                    h.style.textBaseline = y.baseline || "middle",
                    h.style.textFont = this.getFont(y)
                }
                if (this.deepQuery(p, "itemStyle.emphasis.label.show")) {
                    h.highlightStyle.text = c.name,
                    h.highlightStyle.textPosition = "inside";
                    var y = this.deepQuery(p, "itemStyle.emphasis.label.textStyle") || {};
                    h.highlightStyle.textColor = y.color || "#fff",
                    h.highlightStyle.textAlign = y.align || "center",
                    h.highlightStyle.textBaseline = y.baseline || "middle",
                    h.highlightStyle.textFont = this.getFont(y)
                }
        ...
        _buildLinkShapes: function(e) {
            ...
            for (var r = 0; r < n; r++) {
                ...
                l.merge(h.style, this.query(e, "itemStyle.normal.linkStyle"), !0),
                l.merge(h.highlightStyle, this.query(e, "itemStyle.emphasis.linkStyle"), !0),
                typeof o.itemStyle != "undefined" && (o.itemStyle.normal && l.merge(h.style, o.itemStyle.normal, !0), o.itemStyle.emphasis && l.merge(h.highlightStyle, o.itemStyle.emphasis, !0)),
                f.pack(h, e, 0, {
                    source: a.data,
                    target: c.data,
                    weight: i.data.weight || 0
                },
                i.rawIndex, a.name + " - " + c.name, i.data.weight || 0, !0),
                this.shapeList.push(h),
                this.zr.addShape(h),
                i.shape = h;
        ...
        _updateLinkShapes: function() {
            ...
            r = t.length; n < r; n++) {
                ...
                s = i.node1.shape,
                o = i.node2.shape;
                i.shape.style.xStart = s.position[0],
                i.shape.style.yStart = s.position[1],
                i.shape.style.xEnd = o.position[0],
                i.shape.style.yEnd = o.position[1],
                this.zr.modShape(i.shape.id);
                if (i.shape._symbolShape) {
                    var u = i.shape._symbolShape;
                    h.copy(u.position, o.position),
                    h.sub(e, s.position, o.position),
                    h.normalize(e, e),
                    h.scaleAndAdd(u.position, u.position, e, o.style.width / 2 + 2);
                    var a;
                    e[1] < 0 ? a = 2 * Math.PI - Math.acos( - e[0]) : a = Math.acos( - e[0]),
                    u.rotation = a - Math.PI / 2,
                    this.zr.modShape(u.id)
                }
            }
        },
        _syncNodePositions: function() {
            ...
            for (var t = 0; t < e.nodes.length; t++) {
                ...
                if (o) {
                    ...
                    u || (u = this.__nodePositionMap[o] = h.create()),
                    h.copy(u, r)
                }
        ...
        _step: function(e) {
            ...
            this._layout.temperature > .01 && this._layout.step(this._steps)
        },
        refresh: function(e) {
...
function(e) {
    ...
    return l.prototype = {
        ...
        _mapData: function(e) {
            ...
            this.selectedMap[u] && (o = n.stack || s + e[h], i[o] == null ? (i[o] = r, f[r] = [e[h]], r++) : f[i[o]].push(e[h])),
            ...
            E = t; w < E; w++) {
                ...
                x = n.length; S < x; S++) {
                    ...
                    N = n[S].length; T < N; T++) {
                        ...
                        o = i[s],
                        y = o.data[w],
                        b = y != null ? y.value != null ? y.value: y: "-",
                        g[s] = g[s] || [],
                        r[s] = r[s] || {
        ...
        _buildBorkenLine: function(e, t, n, i) {
            ...
            for (var c = e.length - 1; c >= 0; c--) {
                ...
                if (p.type === this.type && d != null) {
                    var v = this._getBbox(h, i),
                    m = this._sIndex2ColorMap[h],
                    ...
                    T = d.length; x < T; x++) {
                        ...
                        C = this._isLarge(i, N);
                        if (!C) for (var k = 0,
                        L = N.length; k < L; k++) l = p.data[N[k][2]],
                        (this.deepQuery([l, p], "showAllSymbol") || n.isMainAxis(N[k][2]) && this.deepQuery([l, p], "symbol") != "none" || this.deepQuery([l, p, this.option], "calculable")) && this.shapeList.push(this._getSymbol(h, N[k][2], N[k][3], N[k][0], N[k][1], i));
                        else N = this._getLargePointList(i, N);
                        var A = new r({
                            zlevel: this._zlevelBase,
                            style: {
                                miterLimit: g,
        ...
        _getBbox: function(e, t) {
            ...
            r = this.xMarkMap[e];
            return t === "horizontal" ? (n[0][1] = Math.min(r.minY, r.maxY), n[1][1] = Math.max(r.minY, r.maxY)) : (n[0][0] = Math.min(r.minX, r.maxX), n[1][0] = Math.max(r.minX, r.maxX)),
            n
        },
    ...
    return a.prototype = {
            ...
            O = e; A < O; A++) {
                ...
                _ = t.length; M < _; M++) {
                    ...
                    P = t[M].length; D < P; D++) {
                        ...
                        u = s[o],
                        k = u.data[A],
                        L = k != null ? k.value != null ? k.value: k: "-",
                        i[o] = i[o] || {
                            min: Number.POSITIVE_INFINITY,
                            max: Number.NEGATIVE_INFINITY,
                            sum: 0,
        ...
        _mapSize: function(e, t, n) {
            ...
            m = t.length; v < m; v++) {
                ...
                y = t[v].length; g < y; g++) {
                    ...
                    l = l != null ? l: this.query(p, "barGap"),
                    c = c != null ? c: this.query(p, "barCategoryGap")
                }
            }
            var S, x;
            if (t.length != a) if (!n) {
        ...
        getMarkCoord: function(e, t) {
            ...
            if (!t.type || t.type !== "max" && t.type !== "min" && t.type !== "average") if (r.isHorizontal) {
                ...
                var a = r[o];
                a = a != null ? a: typeof t.xAxis != "string" && i.getCoordByIndex ? i.getCoordByIndex(t.xAxis || 0) : i.getCoord(t.xAxis || 0),
                u = [a, s.getCoord(t.yAxis || 0)]
            } else {
                o = typeof t.yAxis == "string" && s.getIndexByName ? s.getIndexByName(t.yAxis) : t.yAxis || 0;
                var f = r[o];
                f = f != null ? f: typeof t.yAxis != "string" && s.getCoordByIndex ? s.getCoordByIndex(t.yAxis || 0) : s.getCoord(t.yAxis || 0),
